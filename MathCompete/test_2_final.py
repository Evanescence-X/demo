...
# 定义原材料类型
material_types = [
    MaterialType(1, 5.5, 18, [(1.0, 1.03), (2.5, 2.54)]),
    MaterialType(2, 6.2, 22, [(0.5, 0.52), (1.8, 1.85)]),
    MaterialType(3, 7.8, 28, [(3.0, 3.03)])
]

# 定义订单
orders = [
    Order("学校教学楼", 1.6, 2.2, 10, 480),
    Order("酒店客房", 1.8, 2.4, 20, 680),
    Order("医院病房", 1.7, 2.3, 20, 550),
    Order("政府办公楼", 1.5, 2.0, 15, 420)
]
